  ...
  return GetBuilder<MyGetXController>(builder: (controller) {
    return customColumn(
      ...
      children: [
          ...
          child: RotatedBox(
              ...
              child: SliderTheme(
                  ...
                  child: Slider(
                    ...
                    activeColor: controller.valueSliderAll.value.round() >=
                            MyWidths.SLIDER_RANGE2_VALUE
                        ? MyColor.red
                        : controller.valueSliderAll.value.round() >=
        ...
        text_custom(text: text, size: TextSize.text22, weight: FontWeight.bold),
        const SizedBox(
          height: PaddingD.padding16,
        ),
        const Divider(),
        ...
        Container(
          ...
          child: RotatedBox(
              ...
              child: SliderTheme(
                  ...
                  child: Slider(
                    inactiveColor: Colors.transparent,
                    activeColor: controller.valueSlider.value.round() >=
                            MyWidths.SLIDER_RANGE2_VALUE
                        ? MyColor.red
                        : controller.valueSlider.value.round() >=
                                MyWidths.SLIDER_RANGE1_VALUE
                            ? MyColor.orangePersimmon
                            : MyColor.green_slider,
                    allowedInteraction: SliderInteraction.tapAndSlide,
